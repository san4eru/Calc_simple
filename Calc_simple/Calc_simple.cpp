...
// Calc_simple.cpp: определяет поведение классов для приложения.
//

#include "pch.h"
#include "framework.h"
#include "Calc_simple.h"
#include "Calc_simpleDlg.h"
...
BEGIN_MESSAGE_MAP(CCalcsimpleApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CCalcsimpleApp

CCalcsimpleApp::CCalcsimpleApp()
{
...
// Единственный объект CCalcsimpleApp

CCalcsimpleApp theApp;


// Инициализация CCalcsimpleApp

BOOL CCalcsimpleApp::InitInstance()
{
